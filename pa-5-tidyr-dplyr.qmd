...
columns into. In these data, this could be `"yea"r`.
...
military_long <- military_clean |> 
  pivot_longer(4:35, names_to = "year", values_to = "spending")
...
military_long |> 
  ...
  ggplot(aes(x = spending,
             y = fct_reorder(Country, spending),
             fill = Country)) +
  geom_boxplot() +
  theme_bw() +
  scale_fill_viridis_d() +
  guides(fill = "none") +
  labs(x = "Military Spending as Proportion of Budget",
       y = "Country")
```
